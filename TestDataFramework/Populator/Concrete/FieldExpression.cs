...
namespace TestDataFramework.Populator.Concrete
{
    public class FieldExpression<TListElement, TProperty> : IRangeOperableList<TListElement>
    {
        ...
        public FieldExpression(Expression<Func<TListElement, TProperty>> expression, RangeOperableList<TListElement> rangeOperableList)
        {
        ...
        public virtual FieldExpression<TListElement, TProperty> Value(Func<TProperty> valueFactory, params Range[] ranges)
        {
        ...
        public virtual OperableList<TListElement> GuaranteeByPercentageOfTotal<TValue>(IEnumerable<TValue> guaranteedValues, int frequencyPercentage = 10)
        {
        ...
        public RangeOperableList<TListElement> Set<TValueProperty>(Expression<Func<TListElement, TValueProperty>> fieldExpression, TValueProperty value, params Range[] ranges)
        {
            return this.rangeOperableList.Set(fieldExpression, value, ranges);
        }

        public RangeOperableList<TListElement> Set<TValueProperty>(Expression<Func<TListElement, TValueProperty>> fieldExpression, Func<TValueProperty> valueFactory, params Range[] ranges)
        {
            return this.rangeOperableList.Set(fieldExpression, valueFactory, ranges);
        }

        public FieldExpression<TListElement, TValueProperty> Set<TValueProperty>(Expression<Func<TListElement, TValueProperty>> expression)
        {
