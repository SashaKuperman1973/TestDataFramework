...
namespace Tests.Tests.FieldExpressionTests.ReferenceParentTests
{
    public partial class ReferenceParentFieldExpressionTests
    {
        ...
        public void GuaranteePropertiesByFixedQuantity_TProperty_Test()
        {
            ...
            Func<FieldExpression<ElementType, ElementType.PropertyType>> action = () => this.referenceParentFieldExpression.GuaranteePropertiesByFixedQuantity(values, 5);
        ...
        public void GuaranteePropertiesByFixedQuantity_Func_Test()
        {
            ...
            Func<FieldExpression<ElementType, ElementType.PropertyType>> action = () => this.referenceParentFieldExpression.GuaranteePropertiesByFixedQuantity(funcs, 5);
        ...
        public void GuaranteePropertiesByFixedQuantity_Mixed_TypeAndFunc_Test()
        {
            ...
            Func<FieldExpression<ElementType, ElementType.PropertyType>> action = () => this.referenceParentFieldExpression.GuaranteePropertiesByFixedQuantity(objects, 5);
        ...
        public void GuaranteePropertiesByPercentageOfTotal_TProperty_Test()
        {
            ...
            Func<FieldExpression<ElementType, ElementType.PropertyType>> action = () => this.referenceParentFieldExpression.GuaranteePropertiesByPercentageOfTotal(values, 5);
        ...
        public void GuaranteePropertiesByPercentageOfTotal_Func_Test()
        {
            ...
            Func<FieldExpression<ElementType, ElementType.PropertyType>> action = () => this.referenceParentFieldExpression.GuaranteePropertiesByPercentageOfTotal(funcs, 5);
        ...
        public void GuaranteePropertiesByPercentageOfTotal_Mixed_TypeAndFunc_Test()
        {
            ...
            Func<FieldExpression<ElementType, ElementType.PropertyType>> action = () => this.referenceParentFieldExpression.GuaranteePropertiesByPercentageOfTotal(objects, 5);
            ...
            ElementType.PropertyType[] values, Action<GuaranteedValues> assertFrequency)
        {
            ...
            GuaranteedValues guaranteedValues = this.referenceParentOperableListMock.Object.GuaranteedPropertySetters.Single();
