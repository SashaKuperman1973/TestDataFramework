...
{
    [TestClass]
    public class SqlClientPersistenceComponentTests
    {
        ...
        public void Initialize()
        {
            ...
            {
                ConnectionStringWithDefaultCatalogue = SqlClientPersistenceComponentTests.ConnectionString
            };

            var persistenceService =
                new SqlClientPersistenceService(this.attributeDecorator, this.writePrimitivesMock.Object);
        ...
        public void Insert_Test()
        {
            ...
            this.connectionMock.VerifySet(m => m.ConnectionString = SqlClientPersistenceComponentTests.ConnectionString);
